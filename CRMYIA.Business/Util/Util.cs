...
namespace CRMYIA.Business.Util
{
    public static class Util
    {
        ...
        {
            #region Add Calendario
            long IdConfraternizacao = Business.CalendarioModel.Add(new Calendario() { Descricao = "Confraternização Universal (Ano Novo)", Ativo  = true, DataCadastro = DateTime.Now });
            long IdAniversarioSp = Business.CalendarioModel.Add(new Calendario() { Descricao = "Aniversário de São Paulo", Ativo = true, DataCadastro = DateTime.Now });
            long IdCarnaval = Business.CalendarioModel.Add(new Calendario() { Descricao = "Carnaval", Ativo = true, DataCadastro = DateTime.Now });
            long IdDiaDaMulher = Business.CalendarioModel.Add(new Calendario() { Descricao = "Dia Internacional da Mulher", Ativo = true, DataCadastro = DateTime.Now });
            //Business.CalendarioModel.Add(new Calendario() { Descricao = "Quarta-feira de cinzas", Ativo  = true, DataCadastro = DateTime.Now });
            //Business.CalendarioModel.Add(new Calendario() { Descricao = "Sexta-feira Santa", Ativo  = true, DataCadastro = DateTime.Now });
            long IdPascoa = Business.CalendarioModel.Add(new Calendario() { Descricao = "Páscoa", Ativo = true, DataCadastro = DateTime.Now });
            //Business.CalendarioModel.Add(new Calendario() { Descricao = "Corpus Christi", Ativo  = true, DataCadastro = DateTime.Now });
            long IdDiaDosNamorados = Business.CalendarioModel.Add(new Calendario() { Descricao = "Dia dos Namorados", Ativo = true, DataCadastro = DateTime.Now });
            //var mes = new DateTime(dtAtual.Year, 9, DateTime.DaysInMonth(dtAtual.Year, 9));
            long IdSetembroAmarelo = Business.CalendarioModel.Add(new Calendario() { Descricao = "Setembro Amarelo", Ativo = true, DataCadastro = DateTime.Now });
            long IdOutubroRosa = Business.CalendarioModel.Add(new Calendario() { Descricao = "Outubro Rosa", Ativo = true, DataCadastro = DateTime.Now });
            long IdDiaDasCrianca = Business.CalendarioModel.Add(new Calendario() { Descricao = "Dia das Crianças", Ativo = true, DataCadastro = DateTime.Now });
            long IdDiaDoCorretorDeSeguro = Business.CalendarioModel.Add(new Calendario() { Descricao = "Dia do Corretor de Seguros", Ativo = true, DataCadastro = DateTime.Now });
            long IdDiaDoSecuritario = Business.CalendarioModel.Add(new Calendario() { Descricao = "Dia do Securitário", Ativo = true, DataCadastro = DateTime.Now });
            long IdNovembroAzul = Business.CalendarioModel.Add(new Calendario() { Descricao = "Novembro Azul", Ativo = true, DataCadastro = DateTime.Now });
            long IdNatal = Business.CalendarioModel.Add(new Calendario() { Descricao = "Natal", Ativo = true, DataCadastro = DateTime.Now });
            #endregion
            ...
            while (i < QuantidadeAnos)
            {
                ...
                ListCalendarioSazonal.Add(new CalendarioSazonal() { IdCalendario = IdConfraternizacao, Descricao = "Confraternização Universal (Ano Novo)", Cor = "#1B5E20", Tipo = (byte)EnumeradorModel.TipoSazonal.Feriado, GuidId = GuidIdConfraternizacao.ToString(), DataSazonal = new DateTime(dtAtual.Year, 1, 1), DataCadastro = DateTime.Now, DataInicio = new DateTime(dtAtual.Year, 1, 1).AddDays(-antes), DataFim = new DateTime(dtAtual.Year, 1, 1).AddDays(depois), ExisteCampanha = true, Ativo = true, Repete = (byte)EnumeradorModel.Repete.ACadaAno, Frequencia = (byte)EnumeradorModel.Frequencia.Anualmente });
                ListCalendarioSazonal.Add(new CalendarioSazonal() { IdCalendario = IdAniversarioSp, Descricao = "Aniversário de São Paulo", Cor = "#1B5E20", Tipo = (byte)EnumeradorModel.TipoSazonal.Feriado, GuidId = GuidIdAniversarioSp.ToString(), DataSazonal = new DateTime(dtAtual.Year, 1, 25), DataCadastro = DateTime.Now, DataInicio = new DateTime(dtAtual.Year, 1, 25).AddDays(-antes), DataFim = new DateTime(dtAtual.Year, 1, 25).AddDays(depois), ExisteCampanha = true, Ativo = true, Repete = (byte)EnumeradorModel.Repete.ACadaAno, Frequencia = (byte)EnumeradorModel.Frequencia.Anualmente });
                ListCalendarioSazonal.Add(new CalendarioSazonal() { IdCalendario = IdCarnaval, Descricao = "Carnaval", Cor = "#1B5E20", Tipo = (byte)EnumeradorModel.TipoSazonal.Feriado, GuidId = GuidIdCarnaval.ToString(), DataSazonal = data.AddDays(-47), DataCadastro = DateTime.Now, DataInicio = data.AddDays(-antes -47), DataFim = data.AddDays(depois - 47), ExisteCampanha = true, Ativo = true, Repete = (byte)EnumeradorModel.Repete.ACadaAno, Frequencia = (byte)EnumeradorModel.Frequencia.Anualmente });
                ListCalendarioSazonal.Add(new CalendarioSazonal() { IdCalendario = IdDiaDaMulher, Descricao = "Dia Internacional da Mulher", Cor = "#E65100", Tipo = (byte)EnumeradorModel.TipoSazonal.DataComemorativa, GuidId = GuidIdDiaDaMulher.ToString(), DataSazonal = new DateTime(dtAtual.Year, 3, 8), DataCadastro = DateTime.Now, DataInicio = new DateTime(dtAtual.Year, 3, 8).AddDays(-antes), DataFim = new DateTime(dtAtual.Year, 3, 8).AddDays(depois), ExisteCampanha = true, Ativo = true, Repete = (byte)EnumeradorModel.Repete.ACadaAno, Frequencia = (byte)EnumeradorModel.Frequencia.Anualmente });
                ...
                ListCalendarioSazonal.Add(new CalendarioSazonal() { IdCalendario = IdPascoa, Descricao = "Páscoa", Cor = "#1B5E20", Tipo = (byte)EnumeradorModel.TipoSazonal.Feriado, GuidId = GuidIdPascoa.ToString(), DataSazonal = data, DataCadastro = DateTime.Now, DataInicio = data.AddDays(-antes), DataFim = data.AddDays(depois), ExisteCampanha = true, Ativo = true, Repete = (byte)EnumeradorModel.Repete.ACadaAno, Frequencia = (byte)EnumeradorModel.Frequencia.Anualmente });
