        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CampanhaArquivo>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCalendarioNavigation)
                    ...
                    .HasForeignKey(d => d.IdCalendario)
                    .HasConstraintName("Calendario_CampanhaArquivo");
            ...
            modelBuilder.Entity<Proposta>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdUsuarioCorretor)
                    .HasName("IX_IdUsuarioCorretor");

                entity.HasIndex(e => new { e.Ativo, e.IdUsuario })
                    .HasName("IX_PROPOSTA");

                entity.HasIndex(e => new { e.IdStatusProposta, e.Ativo })
                    .HasName("IX_IdStatusProposta_Ativo");

                entity.HasIndex(e => new { e.Ativo, e.IdUsuarioCorretor, e.DataSolicitacao })
                    .HasName("IX_ATIVO_IDUSUARIOCORRETOR_DATASOLICITACAO");

                entity.HasIndex(e => new { e.ValorPrevisto, e.IdStatusProposta, e.Ativo })
                    .HasName("IX_IdStatusProposta_Ativo_INCLUDE_ValorPrevisto");

                entity.HasIndex(e => new { e.IdUsuarioCorretor, e.ValorPrevisto, e.QuantidadeVidas, e.IdStatusProposta, e.Ativo })
                    .HasName("IX_IdStatusProposta_Ativo_INCLUDE_IdUsuarioCorretor_ValorPrevisto_QuantidadeVidas");
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.IdUsuario, e.Nome, e.Ativo })
                    .HasName("IX_Ativo_IdUsuario_Nome");
