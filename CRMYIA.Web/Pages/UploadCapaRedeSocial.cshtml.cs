...
namespace CRMYIA.Web.Pages
{
    ...
    public class UploadCapaRedeSocial : PageModel
    {
        ...
        [BindProperty]
        public CapaRedeSocial Entity { get; set; }
        ...
        //public async Task<IActionResult> OnPostUploadCampanhaGenericaAsync([FromForm] List<ICollection<IFormFile>> files, CapaRedeSocial formData)//long IdCampanhaArquivo, long IdCampanha, string Descricao, string Observacao, bool Ativo)
        //{
        //    try
        //    {
        //        List<CapaRedeSocialViewModel> EntityLista = null;
        ...
        //                    {
        //                        string NomeArquivoOriginal = Item.;
    ...
    {
        ListEntity = CapaRedeSocialModel.GetList();
    }
    #endregion
}
}
